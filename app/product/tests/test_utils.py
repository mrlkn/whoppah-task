...
class IsValidTransitionTest(TestCase):
    def setUp(self):
        ...
        self.product_instance = type(
            "Product", (object,), {"state": "draft", "created_by": self.creator_user}
        )
    ...
    def test_is_valid_transition(self):
        ...
        is_valid = is_valid_transition(
            self.product_instance, "accepted", self.admin_user
        )
        self.assertTrue(is_valid)
    ...
    def test_is_valid_transition_for_creator(self):
        ...
        self.product_instance.state = "new"
        is_valid = is_valid_transition(
            self.product_instance, "accepted", self.creator_user
        )
        self.assertFalse(is_valid)
    ...
    def test_is_valid_transition_with_invalid_state(self):
        ...
        is_valid = is_valid_transition(
            self.product_instance, "invalid_state", self.admin_user
        )
        self.assertFalse(is_valid)
